...
func (userService *UserService) LoginPwd(u *request.LoginParam) (userInfo *model.SysUser, err error) {
...
func (userService *UserService) Register(param *request.RegisterParam) (*model.SysUser, error) {
...
func (userService *UserService) GetUserInfoList(info request.PageRequest) (list []model.SysUser, total int64, err error) {
	limit := info.PageSize
